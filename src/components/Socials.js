...
const Socials = () => {
  ...
  return (
    <div className="socials flex gap-5 uppercase text-sm fixed left-10 top-[85%] -rotate-90 origin-left text-white/30 bg-black/30 p-5 backdrop-blur-xl z-50" ref={socialRef}>
      {data.map((social) => (
